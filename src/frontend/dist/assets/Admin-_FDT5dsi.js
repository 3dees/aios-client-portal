import { c as createLucideIcon, h as clsx, j as jsxRuntimeExports, i as Slot$1, k as cn, r as reactExports, P as Primitive$1, l as composeRefs, R as React2, m as useComposedRefs, n as reactDomExports, o as React, p as ReactDOM, q as Settings2, B as Bot, f as Layers, C as ChartColumn, F as FileText, u as useClientInfo, v as useUpdateClientInfo, s as systemStatusKind, a as useAgents, w as useUpdateAgent, e as agentStatusKind, b as useLayers, x as useUpdateLayer, d as useMetrics, y as useUpdateMetrics, t as trendKind, g as useDailyBrief, z as useUpdateDailyBrief, D as Separator, E as ue } from "./index-Di-E6i1E.js";
import { C as ChevronDown } from "./chevron-down-DBG5afDs.js";
import { S as Skeleton } from "./skeleton-COCRBjF9.js";
...
function AdminSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground font-display", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { style: { backgroundColor: "oklch(var(--border) / 0.3)" } }),
        children,
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            className: "gap-2",
            style: { minWidth: 130 },
            children: saving ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                className: "flex items-center gap-2",
                "data-ocid": `${ocid}.loading_state`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 border-2 border-t-transparent border-primary-foreground rounded-full animate-spin" }),
                  "Saving…"
                ]
              }
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground", children: [
          label,
          unit && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1.5 text-xs text-muted-foreground font-normal", children: [
            "(",
            unit,
            ")"
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Current" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Target" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Trend" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: trend, onValueChange: onTrendChange, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectTrigger,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Up", children: "↑ Up" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Down", children: "↓ Down" }),
...
function TabSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "admin.loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 w-full rounded-lg" }, i)) });
}
function ClientInfoTab() {
  ...
  async function handleSave() {
    try {
      ...
      ue.success("Client info updated successfully.");
    } catch {
      ue.error("Failed to save client info.");
    }
  }
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(TabSkeleton, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    AdminSection,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm text-muted-foreground", children: "System Status" }),
...
function AgentsTab() {
    ...
    if (data) {
      setDrafts(
        data.map((a) => ({
          ...
          lastActivity: new Date(Number(a.lastActivity)).toISOString().slice(0, 16)
        }))
      );
    }
  }, [data]);
  function update(id, field, val) {
    setDrafts(
      (prev) => prev.map((d) => d.id === id ? { ...d, [field]: val } : d)
    );
  }
  async function handleSave(draft) {
    ...
    try {
      ...
      ue.success(`${draft.name} updated.`);
    } catch {
      ue.error(`Failed to update ${draft.name}.`);
    } finally {
      setSaving(null);
    }
  }
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(TabSkeleton, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "admin.agents.list", children: drafts.map((draft, idx) => {
        ...
        children: [
            ...
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Bot, { className: "w-4 h-4 text-primary shrink-0" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-sm text-foreground", children: draft.name })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: draft.status === "Active" ? "badge-active" : draft.status === "Idle" ? "badge-idle" : "badge-offline",
          ...
          isOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Agent Status" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Select,
                      {
                        value: draft.status,
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Active", children: "Active" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Idle", children: "Idle" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Last Activity (local time)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                      {
                        type: "datetime-local",
                        value: draft.lastActivity,
                        onChange: (e) => update(draft.id, "lastActivity", e.target.value),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    className: "gap-2",
                    children: saving === draft.id ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        className: "flex items-center gap-2",
                        "data-ocid": `admin.agents.loading_state.${idx + 1}`,
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3 h-3 border-2 border-t-transparent border-primary-foreground rounded-full animate-spin" }),
                          "Saving…"
                        ]
                      }
                    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
function LayersTab() {
  ...
  async function handleSave(draft) {
    ...
    try {
      ...
      ue.success(`${draft.name} layer updated.`);
    } catch {
      ue.error(`Failed to update ${draft.name}.`);
    } finally {
      setSaving(null);
  ...
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(TabSkeleton, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: drafts.map((draft, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-primary font-semibold", children: [
            draft.completionPct,
            "%"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Completion % (0–100)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Status Label" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
...
function MetricsTab() {
  ...
  const [deskHours, setDeskHours] = reactExports.useState(5.5);
  const [deskTarget, setDeskTarget] = reactExports.useState(8);
  const [deskTrend, setDeskTrend] = reactExports.useState("Up");
  const [taskPct, setTaskPct] = reactExports.useState(58);
  const [taskTarget, setTaskTarget] = reactExports.useState(60);
  const [taskTrend, setTaskTrend] = reactExports.useState("Up");
  const [revPer, setRevPer] = reactExports.useState(187e3);
  const [revTarget, setRevTarget] = reactExports.useState(2e5);
  const [revTrend, setRevTrend] = reactExports.useState("Up");
  reactExports.useEffect(() => {
    if (data) {
  ...
  async function handleSave() {
    try {
      ...
      ue.success("Metrics updated successfully.");
    } catch {
      ue.error("Failed to save metrics.");
    }
  }
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(TabSkeleton, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function DailyBriefTab() {
  ...
  async function handleSave() {
    try {
      ...
      ue.success("Daily brief updated successfully.");
    } catch {
      ue.error("Failed to save daily brief.");
    }
  }
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(TabSkeleton, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    AdminSection,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm text-muted-foreground", children: "Brief Title" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm text-muted-foreground", children: "Date Label" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: date,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm text-muted-foreground", children: "Executive Summary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              value: summary,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings2, { className: "w-5 h-5 text-primary" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold font-display text-foreground tracking-tight", children: "Management Panel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Update agent statuses, metrics, and brief content without code changes." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary mt-0.5 text-base leading-none", children: "ℹ" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed", children: [
                "Changes are persisted immediately. The client portal reflects updates on next page load. Each section saves independently — click",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: "Save Changes" }),
                " in the relevant tab."
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "client", "data-ocid": "admin.tabs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TabsList,
            {
              ...
              children: TABS.map(({ id, label, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                TabsTrigger,
                {
                  value: id,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-3.5 h-3.5 shrink-0" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "client", "data-ocid": "admin.client.panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClientInfoTab, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "agents", "data-ocid": "admin.agents.panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AgentsTab, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "layers", "data-ocid": "admin.layers.panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayersTab, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "metrics", "data-ocid": "admin.metrics.panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MetricsTab, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "brief", "data-ocid": "admin.brief.panel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DailyBriefTab, {}) })
        ] })
      ]
    }
  );
